    ...
    <div className="min-h-screen flex flex-col relative" style={{ backgroundColor: "#f2ece0", color: "#1c1208" }}>
      ...
      <header className="sticky top-0 z-[80] w-full px-4 md:px-8 py-3 flex items-center justify-between" style={{ backgroundColor: "#2d5a2e", borderBottom: "2px solid #1e3d20" }}>
        ...
        <div className="flex items-center gap-3 md:gap-5 relative">
          ...
          {/* 🤖 Chatbot Icon (Mobile Only Fallback) */}
          <button 
            onClick={() => setActive("chat")} 
            className="md:hidden p-2 rounded-lg transition" style={{ color: "#f5f0e8" }}
          >
          ...
          {/* Three Dot Menu Icon (Desktop) */}
          <button 
            onClick={() => setIsMenuOpen(true)}
            className="hidden md:block p-2 rounded-lg transition hover:bg-white/10" style={{ color: "#f5f0e8" }}
            title="Open Menu"
          >
          ...
          <div className="p-6 md:p-8 min-h-[80vh] rounded-xl" style={{ backgroundColor: "#faf6ef", border: "1px solid #c8b89a", boxShadow: "0 2px 12px rgba(107,66,38,0.10)" }}>
            ...
            {active === "chat" && (
              <div className="bg-white rounded-xl shadow-sm border border-gray-200 overflow-hidden">
                <div className="p-4 bg-gradient-to-r from-green-600 to-green-700 text-white font-bold flex items-center gap-2">
                ...
                <div className="p-4 h-[60vh] overflow-y-auto">
                  <div className="hidden"><FloatingChat /></div>{/* Ensure FloatingChat state doesn't conflict */}
                  <div className="h-full"><Chatbot /></div>
                  <div className="text-gray-500 flex justify-center text-sm items-center h-full">Please use the floating chat button on the bottom right.</div>
                </div>
              </div>
            )}
          </div>
